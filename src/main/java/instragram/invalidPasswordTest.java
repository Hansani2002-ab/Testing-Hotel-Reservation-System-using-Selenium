...
public class invalidPasswordTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            driver.findElement(By.name("password")).sendKeys("Hansani@2002" + Keys.ENTER);
            ...
            try {
                ...
                Files.copy(screenshot.toPath(), Paths.get("C:\\Users\\ASUS\\Desktop\\success.png"));
                System.out.println("📸 Screenshot saved to: C:\\Users\\ASUS\\Desktop\\success.png");
            } catch (Exception ex) {
            ...
            try {
                ...
                File screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
                Files.copy(screenshot.toPath(), Paths.get("C:\\Users\\ASUS\\Desktop\\error.png"));
                System.out.println("⚠ Screenshot saved to Desktop as error.png");
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        } finally {
